...
exports.run = async (client, message, args) => {
  if (!message.author.id === '434434883314647063') return message.reply("You don't have the permission to use this command...:facepalm:");
    //message.delete();
    ...
    if (args[0] === '434434883314647063') return message.reply("You can't blacklist yourself, Dev:joy: That would be horrible.");
